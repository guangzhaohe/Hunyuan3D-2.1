...
class Hunyuan3DPaintConfig:
    def __init__(self, max_num_view, resolution):
        ...
        self.multiview_cfg_path = os.path.dirname(os.path.abspath(__file__)) + "/cfgs/hunyuan-paint-pbr.yaml"
        self.custom_pipeline = os.path.dirname(os.path.abspath(__file__)) + "/hunyuanpaintpbr"
        self.multiview_pretrained_path = "tencent/Hunyuan3D-2.1"
        self.dino_ckpt_path = "facebook/dinov2-giant"
        self.realesrgan_ckpt_path = os.path.dirname(os.path.abspath(__file__)) + "/ckpt/RealESRGAN_x4plus.pth"
